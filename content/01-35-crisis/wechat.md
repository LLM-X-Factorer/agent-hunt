# 公众号长文：我分析了 3786 个 AI 岗位，发现「35 岁危机」可能是假的

## 标题

「我分析了 3786 个国内 AI 岗位，发现 35 岁危机可能是假的」
...
如果你好奇自己在这个市场里处于什么位置，可以到 [agent-hunt.pages.dev](https://agent-hunt.pages.dev) 看完整数据——包括 27 个 AI 角色画像、技能排名、行业分析、国内外对比。
